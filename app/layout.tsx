    ...
    <html lang="en">
      <body className={inter.className}>
        <div className="bg-yellow-50 min-h-screen flex flex-col items-center">
          <nav className="text-white w-full border-b border-dashed border-yellow-500">
            <div className="max-w-3xl w-full flex justify-between items-center mx-auto">
              <div className="w-full px-8 py-4 border-l border-r border-yellow-500">
                <Link href="/">
          ...
          <footer className="text-black w-full border-t border-dashed border-yellow-500">
            <div className="max-w-3xl w-full flex justify-between items-center mx-auto">
              <div className="w-full px-8 py-4 border-l border-r border-yellow-500">
                Hello Footer
              </div>
